...
(function($) {
 ...
 var dlabChartlist = function(){
	...
	var polarChart = function(){
		 ...
		 console.log(document.getElementById('nqrp').dataset['nombre'])
			Chart.defaults.global.legend.display = false;
			var myChart = new Chart(ctx, {
				type: 'polarArea',
				data: {
					labels: ["Q.Rep", "Rep.rep", "Q.rat", "Rep.rat"],
					datasets: [{
						backgroundColor: [
							"#496ecc",
							"#68e365",
						...
						data: [parseInt(document.getElementById('nqrp').dataset['nombre']),
						parseInt(document.getElementById('nrrp').dataset['nombre']),
						parseInt(document.getElementById('nqrt').dataset['nombre']),
						parseInt(document.getElementById('nrrt').dataset['nombre'])] 
					}]
				},
				options: {
