# Generated by Django 4.1 on 2023-09-03 20:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pointCum', models.DecimalField(decimal_places=2, default=0, max_digits=90)),
                ('id_fake', models.CharField(default='2389A1', max_length=50)),
                ('profile', models.ImageField(null=True, upload_to='')),
                ('talent', models.DecimalField(decimal_places=2, default=0, max_digits=99)),
                ('slogan', models.DecimalField(decimal_places=2, default=0, max_digits=99)),
                ('otherPoint', models.DecimalField(decimal_places=2, default=0, max_digits=99)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mc', models.CharField(default='Sara Casseus', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Dedicace',
            fields=[
                ...
                ('show', models.BooleanField(default=False)),
                ('event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.customevent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.customevent')),
        ...
        migrations.AddField(
            model_name='concurent',
            name='event',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.customevent'),
        ),
        migrations.AddField(
            model_name='concurent',
            name='members',
